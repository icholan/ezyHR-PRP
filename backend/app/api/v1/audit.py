...
from app.schemas.audit import AuditLogRead, SystemAuditLogRead, PaginatedAuditLogs, PaginatedSystemAuditLogs
from typing import List, Optional
from uuid import UUID

router = APIRouter(prefix="/audit", tags=["Audit Logs"])

@router.get("/data", response_model=PaginatedAuditLogs)
...
@router.get("/system", response_model=PaginatedSystemAuditLogs)
