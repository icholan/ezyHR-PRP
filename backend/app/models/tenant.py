...
class Entity(Base, IDMixin, TimestampMixin):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False)
    uen: Mapped[str] = mapped_column(String(20), unique=True, nullable=True)
    cpf_account_no: Mapped[str] = mapped_column(String(20), nullable=True)
    iras_tax_ref: Mapped[str] = mapped_column(String(20), nullable=True)
    ...
    gst_no: Mapped[str] = mapped_column(String(20), nullable=True)
    industry_code: Mapped[str] = mapped_column(String(10), nullable=True)
